...
class game{
    constructor(){
        ...
        this.Lilies=new lilies(gameWidth,gameHeight,document.getElementById("Lilies"),240,518,1.5,1.5);
    ...
    createEntities(){
        this.Map.entityGroup.forEach(e=>{
            ...
            if(e.type=="recipeItem"){
                this.Entity.push(new recipeItem(gameWidth,gameHeight,document.getElementById("itemimg"),e.hitbox[0],e.hitbox[1],e.hitbox[2],e.hitbox[3],512,512,e.name,e));
            }
            if(e.type=="entrance"){
